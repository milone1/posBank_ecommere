...
class _ButtonPayCardState extends State<ButtonPayCard> {
  ...
  _printer(name, document, total, list) async {
    var namecito = name.toString();
    var documentito = document.toString();
    ...
    await flutterUsbPrinter
        .printText("------------------------------------------\r\n");
    await flutterUsbPrinter
        .printText(" Cliente       : $namecito                \r\n");
    await flutterUsbPrinter
        .printText(" DNI           : $documentito             \r\n");
    await flutterUsbPrinter
        ...
        children: [
          InkWell(
            onTap: () {
              ...
              _printer( user.user, user.methodPay,cart.getPriceTotal(), cart.cartList);
              cart.clearCart();
...
// class ButtonPayCard extends StatelessWidget {
//   const ButtonPayCard({super.key});
